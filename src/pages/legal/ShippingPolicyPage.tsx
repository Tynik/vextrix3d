    ...
    <Page title="Shipping & Delivery Policy">
      <HoneyFlex $gap={1}>
        ...
        <Text variant="body1">
          ...
          selected service level. Local collection may be offered where available and confirmed
        ...
        <Text variant="body1">
          If your order arrives damaged, please retain the original packaging and contact us within
          48 hours of delivery at{' '}
        ...
        <Text variant="body1">
          Responsibility for the shipment transfers to the customer once the carrier marks the
          parcel as delivered. Vextrix3D is not responsible for delays, loss, or delivery issues
          caused by the carrier, incorrect delivery information provided by the customer, or failed
          delivery attempts, except where damage during transit is verified.
        </Text>
      </HoneyFlex>
