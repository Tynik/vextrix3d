  ...
  return (
    <Page title="Intellectual Property & Copyright Policy">
      <HoneyFlex $gap={1}>
        ...
        <Text variant="body1">
          You retain full ownership of any 3D models, files, or designs that you submit to
          Vextrix3D. By uploading a file, you grant Vextrix3D a limited, non-exclusive, royalty-free
          right to store, process, and manufacture the file solely for the purpose of fulfilling
          your order and providing related customer support.
        </Text>
        ...
        <Text variant="body1">
          ...
          materials provided by Vextrix3D are the intellectual property of Vextrix3D or its
          licensors. You may not copy, reproduce, modify, distribute, or reuse such materials
