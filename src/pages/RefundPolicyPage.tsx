...
export const RefundPolicyPage = () => {
  return (
    <Page title="Refund & Reprint Policy">
      <Text variant="body1">
        Vextrix3D produces custom, made-to-order 3D printed items based on customer-submitted files
        and selected specifications. As a result, refunds and reprints are limited and assessed on a
        case-by-case basis.
      </Text>
      ...
      <ul>
        ...
        <li>
          <Text variant="body1">
            The delivered item is materially different from the approved order specifications (e.g.
            wrong material, colour, or scale).
          </Text>
        </li>
        <li>
          <Text variant="body1">
      ...
      <Text variant="body1">
        ...
        within a reasonable time after delivery, including your order number, a clear description of
        the issue, and supporting photographs. We aim to review all requests and respond within
        three business days.
      </Text>
